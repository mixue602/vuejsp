<template>
	<div class="wapper recycle-wapper" >
		...
		<!-- 提交 -->
    	<footer  class="waves" :class="{'on': submitBtn}"><a @click="getSolution($event)" href="javascript:;">确定</a></footer>
	</div>
</template>
...
export default {
	...
	created() {
		...
		if(!!ss.getItem("repairsaveasse")){
			...
			this.repairsaveasse = repairdata;
...
<style lang="less">
	@import '../../util/fs.less';
	body{background: #fff;}
	.conWapper{margin-bottom:1.306667rem;background: #fff;}
	footer{
