                ...
                <div class="goods-wrapper" ref='goodWrapper'>
                    <ul>
                        <li v-for="(item, index) in goodsobj"  class="good-item">
                            <a class="goodsLink waves" :class="{'bdr-top': index!==0}"  @click.stop='selectAttr(index,$event)' href="javascript:;" >{{item.spunm.length>14?item.spunm.substr(0,14)+'...':item.spunm}}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        methods: {
            ...
            selectAttr(index,event) {
                ...
                setTimeout(function(){
                    ...
                    that.$emit("addpramas",that.parentIndex,that.goodsRender,that.onIndex,1);
                    that._destroyScroll();
                    // that.$emit("addpramas",index,index2,1)   
                }, 200)
            ...
            addPramas() {
                if(this.parentIndex !== null){
                   this.$emit("addpramas",this.parentIndex,this.goodsRender,1);
                   this._destroyScroll();
                }  
            }
        }
                        ...
                        .goods-attr{
                            ...
                            li{
                                ...
                                &.on{
                                   ...
                                   border: 0.013333rem solid #FF9897; 
                                }
                            }
                        }
                    }
