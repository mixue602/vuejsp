<template>
    <div class="picuploadone">
        ...
        <ul class="img-list">
            <!-- <li v-for="(item,index) in uploadArr" class="pic-bg">
               <img :src="item" /> -->
            ...
            methods: {
                ...
                load: function() {
                    ...
                    fileupload.onchange = function() {
                        ...
                        if (files.length + that.uploadArr.length > 2) {
                            alert("最多同时只可上传2张图片");//此处为2是方便第二张图片替换第一张，并非提交两张
                            return;
                        }
...
@import '../../util/fs.less';
    .picuploadone{
        ...
        .img-list li#upload {
            ...
            width: 0.986667rem;
            height: 0.986667rem;
            background: url(//gfs12.gomein.net.cn/T1CsAvB5hT1RCvBVdK.png) no-repeat center;
            background-size: 100%;
        }
        .img-list li img{
            width: 1.306667rem;
        ...
        .img-list li span{
            ...
            width: 0.373333rem;
            height: 0.373333rem;
            background: url(//gfs13.gomein.net.cn/T1nLYvBmb_1RCvBVdK.png) no-repeat center;
