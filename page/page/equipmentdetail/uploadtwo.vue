<template>
    <div class="picuploadtwo">
        <input type="file" id="fileUpload" accept="image/*" multiple>
        <ul class="img-list">
            <!-- <li v-for="(item,index) in uploadArr">
                <img :src="item" /> -->
                <!-- <span :data-index="index" @click="delpic"></span> -->
            <!-- </li> -->
            <li id="upload" @click="load">{{btnMessage}}</li>
        </ul>
        ...
        export default{
            ...
            methods: {
                ...
                load: function() {
                    ...
                    fileupload.click(that.btnMessage);
