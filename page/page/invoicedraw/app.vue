<template>
	<div id="invoicedraw" class="wapper">
        ...
        <div class="wapper">
            <!-- 内容明细区 -->
           <ul class="securelist">
                <li id="phoneNum" class="bdr-bottom" :class="{'inpCha1':bigInp1}">
                    <input class="js-phone" @input='changeVcode' v-model='phoneNum' type="tel" placeholder="请输入手机号"  maxlength="11">
                </li>
            </ul>
            <p class='drawTip'>请输入申请发票时预留的手机号</p>
           <!--  <div class="subBtn"><a class="subBtnLink"  :class='{"on":subBtn}' :class='{"on":vcodeOn}' @click='getVcode' href="javascript:;">获取验证码</a></div> -->
           <div class="subBtn"><a class="subBtnLink" :class='{"on":vcodeOn}' @click='getVcode' href="javascript:;">获取验证码</a></div>
        </div>

        <!-- <div class="wapper_tip" v-show="codebox">
            <ul class="securelist">
...
export default {
    ...
    methods:{
        ...
        changeVcode(){
            ...
            //获取验证码按钮高亮
            if(this.phoneNum.length==11 && /[0-9]+/g.test(this.phoneNum)){
                this.vcodeOn = true;
            }else{
                this.vcodeOn = false;
            }  
