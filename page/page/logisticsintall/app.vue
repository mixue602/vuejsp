                            ...
                            <li class="message-li" :key="index" >
                                ...
                                <div class="order-box" @click="hrefToUrl(item)">
                                    <div class="title-box">
                                        ...
                                        <span v-if="item.serviceCompany!=null" class="express">{{item.serviceCompany}}</span>
                                    </div>
...
export default {
    data () {
        return {
            ...
            len:10,
            list:[],
            readType:1, //用户标记已读 1:物流安装消息，2：服务消息
        };
    },
    methods:{
	    //物流安装提醒根据 类型 和状态对应的跳转地址
        hrefToUrl(obj){
            let that = this;
            ...
            let messageType = obj.messageType,
                ...
                messageState = obj.messageState,
                shippingGroupId =  obj.shippingGroupId;
            if(messageState==2){//跳转退款详情页
                //跳转退款详情页
                let params ={
                    otn:orderNo,
                    odtype:orderType,
                ...
                util.href('./ordersrefunddetail.html',params);
            }else if(messageState==3||messageState==4||messageState==6){ //跳转物流安装轨迹页
                let params ={
                    resumeType:messageType,
                    dodt:orderTime,
                    oid:orderNo,
                ...
                //跳转配送/安装轨迹
                util.href('./ordertrack.html',params);
            }else{ //中台订单详情页
                let params ={
                    // 订单id
                    oid:orderNo,
                ...
                util.href('./ordersztdetail.html',params);
            }
         ...
         */
          getInstallNews(obj){
                let that = this;
                util.api({
                    //surl:'/resources/json/logisticsintall.json',
                    surl: root.ME_API_PATH + 'express/list',
                    data: {
                        pageNo: obj.curpg,
                        pageSize: obj.len
                    },
